...
-   [**`{github}`**](https://github.com/cscheid/rgithub)... GitHub APIラッパーパッケージその１
-   [**`{gistr}`**](https://github.com/ropensci/gistr)... gist管理
-   [**`{gh}`**](https://github.com/gaborcsardi/gh)... GitHub APIラッパーパッケージその２。Hadleyが **`{devtools}`**と相互性を持たせようとしていて、未来が明るい感じがある (<https://github.com/gaborcsardi/gh/issues/30>)
